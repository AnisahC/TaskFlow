...
const features = [
  {
    ...
    description: "New to TaskFlow? Easily set your Task by clicking the + button",
  },
  {
    imageSrc:
  ...
  <div className="flex gap-6 items-center">
    ...
    <div className="flex flex-col self-stretch my-auto max-md:max-w-full">
      <div className="flex flex-col max-md:max-w-full">
        <h3 className="text-base font-bold text-pink-700">{title}</h3>
        <p className="mt-2 text-sm text-green-700 max-md:max-w-full">
          {description}
        </p>
      </div>
    </div>
  ...
  return (
    <section className="mt-10 flex flex-col max-md:mt-10 ">
      <div className="flex flex-col mx-5">
        <article className="flex flex-col justify-center bg-gradient-to-r from-pink-100 to-green-100 p-px rounded-2xl max-md:max-w-full pt-10">
          <div className="flex overflow-hidden flex-col justify-center pr-10 pb-10 pl-10 rounded-2xl max-md:max-w-full">
            <h2 className="text-xl font-bold text-pink-700 max-md:mt-10">
              Get Started with Your First Task!
            </h2>
            <p className="text-sm text-green-700 max-md:mt-10 mb-8">
